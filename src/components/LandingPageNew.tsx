...
function LandingPage() {
  ...
  return (
    <Container fluid style={{ minHeight: `${availableHeight}px` }}>
      <Container
        fluid
        style={{
          backgroundImage:
            "url('https://www.roadtovr.com/wp-content/uploads/2021/05/spectacles-ar-glasses-2.jpg')",
          minHeight: `100vh`,
      ...
      >
        <Col className="d-flex flex-column align-items-center justify-content-center">
          ...
          <div className="motto-text">
            The same world, but in a different way
          </div>
          <Button
